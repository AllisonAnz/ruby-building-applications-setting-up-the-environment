...
#config/environment.rb is also a commone place for configuring
#application settings
#this is an ideal location, for instance, for configuring access
#to a database that an application can use. 